                ...
                <div class="col-md-3">
                    <div class="card mb-3 product-wap rounded-0">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Modificar JUGADOR-->
                            <a class="btn btn-secondary" href="./Administrador/modificar_partido.php?id=<?php echo $cod?>">
                            ...
                            <!-- Eliminar JUGADOR-->
                            <a class="btn btn-danger" href="./Administrador/eliminarPartido.php?id=<?php echo $cod?>">
